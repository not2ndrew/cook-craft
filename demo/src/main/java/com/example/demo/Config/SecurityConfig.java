...
import static com.example.demo.Enum.Role.*;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(request -> {
                // The home page is only for Users, Admins, and Manager
                // request.requestMatchers("/home").hasAnyRole(USER.name(), ADMIN.name(), MANAGER.name());
                request.requestMatchers("/users").hasRole(ADMIN.name());
